                    ...
                    <div class="card-body">
	                    ...
	                    <table class="table table-sm text-nowrap" id="datatable">
	                    	...
	                    	<tbody>
	                        	...
	                        	<tr>
		                        	<td>{{ $no++ }}</td>
		                            <td>{{ $purchases->nama_barang }}</td>
		                            <td>{{ $purchases->kategori }}</td>
		                            <td>{{ $purchases->qty }}</td>
		                            <td>		                            	             
                                    <a href="{{ route('purchase-delete', $purchases ->id_purchase) }}" class="btn btn-danger">Delete</a>
                                    </td>
                        ...
                        <div class="box-footer" style="padding:0 0 20px 20px">
                            <a href="{{ route('purchase-update') }}" class="btn btn-success"><i class="glyphicon glyphicon-circle-arrow-right"></i>Simpan</a>
                                </br><br>
